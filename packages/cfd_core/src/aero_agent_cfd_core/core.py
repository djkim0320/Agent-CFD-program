...
class CFDCore:
    ...
    def build_preflight_response(
        ...
        *,
        snapshot_id: str,
        subagent_findings: SubagentFindings | None,
        ai_assist_mode: AIAssistMode,
        ai_review_status: AIAssistMode,
        ...
        runtime_blocker_details: list[dict[str, object]],
    ) -> PreflightResponse:
        return PreflightResponse(
            ...
            runtime_blocker_details=runtime_blocker_details,
